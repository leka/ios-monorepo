...
public struct LibraryActivityListView: View {
    ...
    public var body: some View {
        Table(self.activities) {
            TableColumn("Activity") { activity in
