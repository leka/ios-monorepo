    ...
    struct Player: View {
        ...
        enum Stimulation: String, CaseIterable {
            ...
            public func icon() -> Image {
                switch self {
                    case .light:
                        ContentKitAsset.GameEngineExercises.HideAndSeek.iconStimulationLight.swiftUIImage
                    case .motion:
                        ContentKitAsset.GameEngineExercises.HideAndSeek.iconStimulationMotion.swiftUIImage
                }
            }
        }
