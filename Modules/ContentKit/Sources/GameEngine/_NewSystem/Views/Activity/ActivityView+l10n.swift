...
extension l10n {
    enum ActivityView {
        ...
        enum InfoSheet {
            static let unavailableMessage = LocalizedString("game_engine_kit.activity_view.info_sheet.unavailable_message",
                                                             bundle: ContentKitResources.bundle,
                                                             value: "Activity details are unavailable right now.",
                                                             comment: "Fallback message when the activity information sheet cannot be displayed")
        }
    }
}
