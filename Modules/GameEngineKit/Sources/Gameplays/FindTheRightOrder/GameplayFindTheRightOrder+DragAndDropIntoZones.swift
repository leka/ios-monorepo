...
// MARK: - GameplayDragAndDropToSequenceChoiceModel

struct GameplayDragAndDropToSequenceChoiceModel: GameplayChoiceModelProtocol {
...
extension GameplayDragAndDropToSequenceChoiceModel: Equatable {
    static func == (lhs: GameplayDragAndDropToSequenceChoiceModel, rhs: GameplayDragAndDropToSequenceChoiceModel) -> Bool {
        lhs.id == rhs.id
    }
}

extension GameplayFindTheRightOrder where ChoiceModelType == GameplayDragAndDropToSequenceChoiceModel {
    convenience init(choices: [GameplayDragAndDropToSequenceChoiceModel], allowedTrials: Int? = nil) {
        self.init()
