...
// MARK: - ActionThenTTSCoordinatorAssociateCategories

public class ActionThenTTSCoordinatorAssociateCategories: ActionThenTTSGameplayCoordinatorProtocol {
    // MARK: Lifecycle

    public init(gameplay: NewGameplayAssociateCategories, action: Exercise.Action) {
...
extension ActionThenTTSCoordinatorAssociateCategories {
    enum State {
        case idle
        case selected
        case correct
...
#Preview {
    ...
    let coordinator = ActionThenTTSCoordinatorAssociateCategories(gameplay: gameplay, action: .robot(type: .color("red")))
