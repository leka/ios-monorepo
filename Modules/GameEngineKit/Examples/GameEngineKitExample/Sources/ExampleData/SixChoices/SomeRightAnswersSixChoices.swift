...
private var steps: [StandardStepModel] = [
    StandardStepModel(choices: step1, gameplay: .selectSomeRightAnswers, answersNumber: 2),
    StandardStepModel(choices: step2, gameplay: .selectSomeRightAnswers, answersNumber: 1),
    StandardStepModel(choices: step3, gameplay: .selectSomeRightAnswers, answersNumber: 3),
    StandardStepModel(choices: step4, gameplay: .selectSomeRightAnswers, answersNumber: 1),
    StandardStepModel(choices: step5, gameplay: .selectSomeRightAnswers, answersNumber: 2),
]

public struct SomeAnswersSixChoicesActivity: View {
