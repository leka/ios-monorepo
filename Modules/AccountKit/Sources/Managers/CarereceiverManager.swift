...
public class CarereceiverManager {
    ...
    public func updateCarereceiver(carereceiver: inout Carereceiver /* , documentID: String */ ) {
        carereceiver.lastEditedAt = nil
        self.dbOps.update(data: carereceiver, in: .carereceivers /* , documentID: documentID */ )
    ...
    public func updateAndSelectCarereceiver(carereceiver: inout Carereceiver /* , documentID: String */ ) {
        carereceiver.lastEditedAt = nil
