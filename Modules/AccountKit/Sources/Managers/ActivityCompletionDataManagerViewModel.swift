...
public class ActivityCompletionDataManagerViewModel: ObservableObject {
    ...
    @Published public var rootOwnerCompletionData: [ActivityCompletionData] = []
//    @Published public var currentActivity:
    ...
    private func subscribeToManager() {
        self.activityCompletionDataManager.rootOwnerCompletionData
            .receive(on: DispatchQueue.main)
            .sink(receiveValue: { [weak self] fetchedData in
                self?.rootOwnerCompletionData = fetchedData
            })
