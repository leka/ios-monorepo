...
public struct Caregiver: AccountDocument {
    ...
    // Back to simple mapping except for theme and scheme
    // make theme like scheme (+cf P. Friese on ipad mini)
    // don't forget to add lastEditedAt (which should be nil) to be sure it's updated
