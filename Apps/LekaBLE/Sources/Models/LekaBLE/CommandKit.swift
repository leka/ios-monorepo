...
enum LKCommand {
	...
	//	static let led: UInt8 = 0x10
	static let ledFull: UInt8 = 0x13
	static let ledRange: UInt8 = 0x16
	static let motor: UInt8 = 0x20
	static let guidance: UInt8 = 0x40
...
class CommandKit {
	...
	func addAllLeds(of earOrBelt: UInt8, rgbColor red: UInt8, _ green: UInt8, _ blue: UInt8) {
		...
		let array = [LKC.LedFull.command, earOrBelt, red, green, blue, checksum8([earOrBelt, red, green, blue])]
	...
	func addMotor(on leftOrRight: UInt8, direction: UInt8, speed: UInt8) {
		...
		let array = [LKC.Motor.command, leftOrRight, direction, speed, checksum8([leftOrRight, direction, speed])]
	...
	func addMotivator(_ motivator: UInt8) {
		...
		let array = [LKC.Motivator.command, motivator, checksum8([motivator])]
