...
private var steps: [StandardStepModel] = [
    StandardStepModel(
        ...
        interface: .listenFourChoicesInline(AudioRecordingModel(name: "guitar", file: "guitar"))),
    StandardStepModel(
...
struct ListenThenTouchToSelectFourChoicesInlineActivity: View {
...
struct ListenThenTouchToSelectFourChoicesInlineActivity_Previews: PreviewProvider {
    static var previews: some View {
        ListenThenTouchToSelectFourChoicesInlineActivity()
