...
class ActivitiesVM: NSObject, ObservableObject, YamlFileDecodable {
...
//    @Published var blurryBGOpacity: Double = 0
...
//    // Here because UIData is @EnvironmentObject
...
//        utterance.rate = 0.40
//        utterance.voice = Locale.current.languageCode == "fr" ? AVSpeechSynthesisVoice(language: "fr-FR") : AVSpeechSynthesisVoice(language: "en-US")
//
//        isSpeaking = true
...
//        steps = with.steps
//        // If current activity has to repeat steps (assuming the model is always 5 provided / 10 expected steps...)
//        if steps.count != 10 {
...
//        percent = 0
//        pressedIndex = 100
//        images = steps[currentStep].elements
//        sound = steps[currentStep].sound?[0] ?? ""
//        checkMediaAvailability()
//        // Randomize answers
//		if let isRandom = selectedActivity.randomElementPosition {
//			if isRandom {
//				images.shuffle()
//			}
//		}
...
//        setupGame(with: selectedActivity)
