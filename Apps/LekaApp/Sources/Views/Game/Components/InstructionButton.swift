...
struct InstructionButton: View {
    ...
    var body: some View {
        ...
        .background(
            ZStack {
                Color.white
                LinearGradient(gradient: Gradient(colors: [.black.opacity(0.1), .black.opacity(0.0), .black.opacity(0.0)]), startPoint: .top, endPoint: .center)
                    .opacity(activityVM.isSpeaking ? 1 : 0)
            })
        .overlay(
            RoundedRectangle(cornerRadius: gameMetrics.roundedCorner, style: .circular)
                .fill(.clear, strokeBorder: LinearGradient(gradient: Gradient(colors: [.black.opacity(0.2), .black.opacity(0.05)]), startPoint: .bottom, endPoint: .top), lineWidth: 4)
