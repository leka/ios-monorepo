...
enum TileData: Int, CaseIterable, Hashable {
    ...
    var content: TileContent {
        switch self {
            ...
            case .discovery:
                return TileContent(title: "Le mode découverte",
            ...
            case .curriculums:
                return TileContent(image: "curriculums",
                                   title: "Les parcours",
                                   subtitle: "Les parcours sont des compilations d'activités dont la difficulté est évolutive.",
                                   message: "Les parcours ont pour objectif d'atteindre des compétences précises. Ils ont été pensé avec des professionnels du médico-social. \nVous pouvez réaliser les activités dans l'ordre ou sauter des niveaux.")
            case .activities:
                return TileContent(image: "activities",
                                   title: "Les activités",
                                   subtitle: "Les activités vous permettent de travailler des compétences variées !",
                                   message: "Vous trouverez au sein de votre application diverses activités variées. Elles peuvent intéresser les différents métiers du médico-social afin de faire progresser les utilisateurs.")
            case .commands:
                return TileContent(image: "commands",
                                   title: "Les commandes",
                                   subtitle: "Les commandes vous permettent de créer des activités en utilisant Leka comme médiateur !",
                                   message: "Vous pouvez télécommander Leka, le faire tourner, lancer un renforçateur ou encore allumer ses leds dans la couleur souhaitée ! \nL'objectif des commandes est de vous permettre de créer votre propre activité avec l'utilisateur et d'entrer en interaction avec lui.")
            case .stories:
                return TileContent(image: "stories",
                                   title: "Les histoires",
                                   subtitle: "Les histoires sont interactives !",
                                   message: "Vous allez pouvoir lire les aventures de Leka durant vos séances tout en intégrant des activités à réaliser au cours de l'histoire !")
            case .teacher:
                return TileContent(image: "accompanying",
                                   title: "Le suivi",
                                   subtitle: "Le suivi permet de garder en mémoire l'utilisation de Leka avec chaque profil.",
                                   message: "Le suivi se présente sous la forme d'un historique. Vous y trouverez l'ensemble des activités réalisées de la plus récente à la plus ancienne.")
            case .user:
                return TileContent(image: "user",
                                   title: "Le suivi",
                                   subtitle: "Le suivi permet de garder en mémoire l'utilisation de Leka avec chaque profil.",
                                   message: "Le suivi se présente sous la forme d'un historique. Vous y trouverez l'ensemble des activités réalisées de la plus récente à la plus ancienne.")
            // New company signup path
            case .signup_step1:
                return TileContent(image: "welcome",
