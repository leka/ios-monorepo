...
def check_author_definitions(filename):
    """Check author definitions"""
...
def main():
    ...
    if len(sys.argv) > 1:
        author_definitions_files = sys.argv[1:]
    else:
    ...
    for file in author_definitions_files:
        file_is_valid = check_author_definitions(file)
